...
# We show here how the configuration for the app lives inside Asana and is read when the script is run
...
# If there isn't a second ID for a separate project that contains the Asana configuration,
